export class SoundManager {
  ...
  play(soundName?: string) {
    ...
    try {
      switch (name) {
        case "asmrClick": this.playTone(800, 0.1); break;
        case "softBloom": this.playTone(400, 0.3, "sine"); break;
        case "glassChime": this.playChime(); break;
        default: this.playTone(600, 0.15); // default
      }
